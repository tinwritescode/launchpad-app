...
const dataSource2 = [
  {
    key: '1',
    project: {name:'John Brown',pricePerToken:100,tokenSymbol:'PSC' ,img:'https://picsum.photos/200/300',link:'http://localhost:3000/'},
...
const columns = [
  {
    ...
    dataIndex: 'project',
    key: 'project',
    render: (project:{name:string,
                      pricePerToken: number,
                      tokenSymbol: string,
                      img: string,
                      link: string,}) => <S.ProjectInfo item={project}/>,
  },
  {
    title: 'CHAIN',
    dataIndex: 'chain',
    key: 'chain',
    render: (imageUrl:string) => <S.StyledChainImage src={imageUrl}></S.StyledChainImage>
  },
  {
    title: 'END IN',
    dataIndex: 'endTime',
